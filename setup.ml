...
(* OASIS_START *)
(* DO NOT EDIT (digest: b141710495a4f772bfd82f33c915604f) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("prove", ["./main.byte"]))];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Fabian Pijcke <fabian@pijcke.net>"];
          homepage = Some "https://github.com/shepard8/ocaml-latexp";
          bugreports = None;
          synopsis = "Defines simple parsers for LaTeX-like strings";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("testsimple", None);
                           InternalLibrary "latexp"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/shepard8/ocaml-latexp.git";
                      src_repo_browser =
                        Some "https://github.com/shepard8/ocaml-latexp";
     ...
     oasis_digest =
       Some "\253\132\135=F\025\186\211\029\237t\199\175\168\n\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
