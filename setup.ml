...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3a524ceec4f7c762747cb41446a2f037) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis = "Parsing LaTeX-like text in OCaml";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\207z\196\189r?\235w\230fa~r\171p\169";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
